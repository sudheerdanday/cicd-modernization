...
import (
	...
	"bitbucket.org/orbitanalytics/cicd-modernization/orbit-deployer/pkg/cmd/deployer"
...
func init() {
	...
	deployCmd.Flags().StringVarP(&options.Cluster, "cluster", "t", "", "Cluster Type Option")
